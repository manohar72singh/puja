...
import { 
  Calendar, Clock, MapPin, User, MessageCircle, Heart, ChevronRight, 
  Shirt, Flame, Sparkles, ArrowRight, UtensilsCrossed, Coffee, CheckCircle
} from "lucide-react";
...
const HomePujaPaymentDetails = () => {
  ...
  const [formData, setFormData] = useState({
    date: "", time: "", location: "", devoteeName: "", gotra: ""
  });
  ...
  const contributionOptions = [
    { id: 'vastra', name: 'Vastra Daan', price: 251, icon: <Shirt size={18} />, desc: 'Donate clothes to the needy' },
    { id: 'annadan', name: 'Annadan', price: 501, icon: <Coffee size={18} />, desc: 'Provide meals to the hungry' },
    { id: 'deepdan', name: 'Deepdan', price: 101, icon: <Flame size={18} />, desc: 'Light lamps at sacred temples' },
    { id: 'bhoj', name: 'Brahmin Bhoj', price: 1100, icon: <UtensilsCrossed size={18} />, desc: 'Feed Brahmins after ceremony' },
  ];
  ...
  const grandTotal = service.price + service.samagriPrice + getDharmicTotal() + (donations.temple ? 1 : 0);
            ...
            <div className={`${mainCardStyle} p-8`}>
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">Complete your sacred booking</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  ...
                  <p className="text-[11px] text-gray-500 mb-4 font-medium">These details will be used during the sacred Sankalp (ritual pledge)</p>
            ...
            <div ref={dharmicRef} className={`${mainCardStyle} p-8 space-y-6 scroll-mt-28`}>
                ...
                {contributionOptions.map((option) => (
                  <div 
                    ...
                    className={`p-5 flex justify-between items-center transition-all cursor-pointer rounded-xl border-2 ${
                      donations[option.id] ? 'border-orange-500 bg-orange-50/30' : 'border-orange-200 hover:border-orange-200' 
                    }`}
                  >
              ...
              <div 
                ...
                className={`p-5 flex justify-between items-center transition-all cursor-pointer rounded-xl border ${
                  donations.gau ? 'border-orange-500 bg-orange-50/30' : 'border-orange-200 hover:border-orange-200 bg-white'
                }`}
              >
                <div className="flex items-center gap-4">
            ...
            <div className={`${mainCardStyle} p-8 !rounded-[1.5rem] shadow-lg`}>
              ...
              <div className="space-y-4">
                <div className="pb-4 border-b border-orange-200">
                  <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Puja</p>
                  <h4 className="text-sm font-black text-gray-900">{service.title}</h4>
                ...
                >
                    ...
                    <span className="text-orange-600 font-black text-sm">₹{getDharmicTotal()}</span>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="flex justify-between items-center text-[11px] font-bold text-gray-700 uppercase">
                    ...
                    <span className="text-gray-900 font-black">+₹{service.samagriPrice}</span>
                  </div>
                  ...
                  <button className="w-full bg-gradient-to-r from-orange-400 to-orange-500 text-white font-bold py-3.5 rounded-xl shadow-md flex items-center justify-center gap-2 active:scale-95 transition-all">
                    <span className="text-sm flex items-center gap-2"><ArrowRight size={16} /> Pay ₹{grandTotal}</span>
                  </button>
