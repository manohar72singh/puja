        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-orange-200 hover:border-orange-500 transition-all duration-300 flex items-center justify-between shadow-sm group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-800">
                      Add Complete Samagri Kit
                    </h3>
                    <p className="text-gray-500 text-sm">
                      Everything from flowers to pure ghee included.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-end gap-1">
                  ...
                  >
                    <div
                      className={`bg-white w-5 h-5 rounded-full shadow-md transform duration-300 ${samagriEnabled ? "translate-x-7" : "translate-x-0"}`}
                    ></div>
                  </button>
              ...
              <section ref={sections.about} className="scroll-mt-32 pt-2">
                ...
                <div className="bg-white p-6 rounded-2xl border border-orange-200 hover:border-orange-500 transition-all duration-300 text-gray-600 leading-relaxed shadow-sm">
                  {/* {service?.puja_name} is a divine ritual that ensures peace,
                  prosperity, and wealth. Our Pandits are trained to perform
                  this according to the ancient Vedic traditions.The Sri
                  Satyanarayan Vrat Katha is a worship of the true form of Lord
                  Vishnu, performed for happiness, prosperity, and the
                  fulfillment of desires. Taken from the Revakhand of the Skanda
                  Purana, this story describes the glory of the Lord and the
                  significance of the fast through life examples of a poor
                  Brahmin, King Ulkamukha, and a merchant sage. This story and
                  worship are considered extremely fruitful, especially in the
                  Kali Yuga. */}
                  {service?.description}
                </div>
              </section>
          ...
          <div className="lg:col-span-1 lg:sticky lg:top-[90px] z-30">
            <div className="bg-white rounded-3xl shadow-xl border border-orange-200 p-6">
              <h2 className="text-xl font-bold mb-6 text-gray-800 border-b border-orange-100 pb-2">
                Booking Summary
              </h2>
...
const BenefitCard = ({ icon, title, desc }) => (
  <div className="bg-white p-5 rounded-2xl flex items-start gap-4 border border-orange-200 hover:border-orange-500 transition-all duration-300 shadow-sm group">
    <div className="p-3 bg-orange-50 text-orange-500 rounded-xl group-hover:bg-orange-500 group-hover:text-white transition-all border border-orange-100">
      {icon}
    </div>
    <div>
...
const FAQItem = ({ q, a }) => (
  <details className="group bg-white rounded-xl border border-orange-200 hover:border-orange-500 transition-all p-4 list-none shadow-sm">
    ...
    <p className="text-xs text-gray-500 mt-3 pt-3 border-t border-orange-50">
      {a}
    </p>
  </details>
);
