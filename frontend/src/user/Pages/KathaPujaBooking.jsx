                ...
                <div className="pt-6 mt-2 border-t border-dashed border-orange-200">
                  <div className="flex justify-between items-center">
                    <div className="flex flex-col">
                      <span className="text-[11px] font-black uppercase text-gray-400 tracking-[0.15em] leading-none">Total Amount</span>
                    ...
                    <div className="text-right">
                      <span className="text-4xl font-serif font-bold text-orange-600 tracking-tighter">₹{totalAmount}</span>
                    </div>
                  </div>
                </div>
              </div>
