...
const KathaPujaPaymentDetails = () => {
  ...
  const handlePayment = async () => {
    ...
    const payload = {
      ...
      pincode: formData.pincode, devoteeName: formData.devoteeName, bookingId,
    };
    try {
              ...
              <div ref={dharmicRef} className="bg-white rounded-2xl border border-orange-200 shadow-sm p-5 md:p-8 space-y-4 md:space-y-6 scroll-mt-28">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[11px] text-gray-500 font-medium">Feed a cow on your behalf — an auspicious addition</p>
                  </div>
