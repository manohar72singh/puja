...
const Icon = ({ name }) => {
  const icons = {
    ...
    users: (
      <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
        <circle cx="8" cy="7" r="4" /><path d="M2 21v-1a6 6 0 0 1 12 0v1" />
        <circle cx="17" cy="9" r="3" /><path d="M22 21v-1a5 5 0 0 0-7-4.6" />
      </svg>
    ),
    pandits: (
      <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "24px 20px 16px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        <p style={{ color: "#6b7280", fontSize: 10, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 4 }}>
          MODULES
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div>
          <div style={{ color: "#f9fafb", fontSize: 14, fontWeight: 700 }}>Super Admin Control</div>
          <div style={{ color: "#6b7280", fontSize: 11 }}>Sri Vedic Puja • admin@srivedicpuja.com</div>
        </div>
      </div>
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 8, color: "#d1d5db", padding: "8px 14px",
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }}>
        <div>
          <h1 style={{ color: "#f9fafb", fontSize: 26, fontWeight: 700, margin: 0, fontFamily: "'DM Sans', sans-serif" }}>
            God View Dashboard
          </h1>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, color: "#22c55e", fontSize: 12, fontFamily: "'DM Sans', sans-serif" }}>
            <Icon name="wifi" />
            <span>Live</span>
          </div>
          <button
      ...
      >
        <div>
          <div style={{ color: "rgba(255,255,255,0.8)", fontSize: 12, fontFamily: "'DM Sans', sans-serif", marginBottom: 4 }}>
            Total Revenue (All Time)
          </div>
          <div style={{ color: "#fff", fontSize: 32, fontWeight: 800, fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div style={{ textAlign: "right" }}>
          <div style={{ color: "rgba(255,255,255,0.8)", fontSize: 11, fontFamily: "'DM Sans', sans-serif", marginBottom: 4 }}>
            Last Updated
          </div>
          <div style={{ color: "#fff", fontSize: 18, fontWeight: 700, fontFamily: "'DM Sans', sans-serif", letterSpacing: "0.05em" }}>
            {time}
          </div>
        </div>
      </div>
...
const GodTile = ({ icon, value, label, iconBg }) => (
  ...
  >
    ...
    <div style={{ color: "#f9fafb", fontSize: 22, fontWeight: 700, fontFamily: "'DM Sans', sans-serif" }}>{value}</div>
    <div style={{ color: "#6b7280", fontSize: 12, fontFamily: "'DM Sans', sans-serif" }}>{label}</div>
  </div>
);
            ...
            {tab === "Dashboard" && (
              <>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 14, marginBottom: 20 }}>
                  <GodTile icon="🕉" iconBg="rgba(139,92,246,0.2)" value={stats.activePujas ?? 9} label="Active Pujas" />
                  <GodTile icon="⏳" iconBg="rgba(234,179,8,0.2)" value={stats.pendingRequests ?? 6} label="Pending Requests" />
                ...
                >
                  ...
                  <div>
                    <div style={{ color: "#22c55e", fontWeight: 600, fontSize: 14 }}>All Clear – No At-Risk Bookings</div>
                    <div style={{ color: "#6b7280", fontSize: 13, marginTop: 2 }}>All upcoming bookings have pandits assigned. Great job!</div>
                  </div>
                </div>
